...
namespace TheAionProject
{
    ...
    public class ConsoleView
    {
        ...
        public int DisplayeGetGameObjectToLookAt()
        {
            int gameObjectId = 0;
            bool validGamerObjectId = false;

            //
            // get a list of game objects in current space-time location
            //
            ...
            if (gameObjectsInSpaceTimeLocation.Count > 0)
            {
                ...
                while (!validGamerObjectId)
                {
                    ...
                    {
                        ClearInputBox();
                        DisplayInputErrorMessage("It appears you enetred an invalid game object is. Please try again.");
                    }
                }
            ...
            {
                DisplayGamePlayScreen("Look at an Object", "It appears there are no objects here", ActionMenu.MainMenu, "");
            }
        ...
        public int DisplayGetTravelerObjectsToPickUp()
        {
            int gameObjectId = 0;
            ...
            if (travelerObjectsInSpaceTimeLocation.Count > 0)
            {
                ...
                while (!validGameObjectId)
                {
                    ...
                    if (_gameUniverse.IsValidTravelerObjectByLocationId(gameObjectId, _gameTraveler.SpaceTimeLocationID))
                    {
                        ...
                        {
                            ClearInputBox();
                            DisplayInputErrorMessage($"It appears you may not add {travelerObject.Name} to your inventory.");
                        }
                    }
                    else
                    {
        ...
        public int DisplayGetInventoryObjectToPutDown()
        {
            ...
            {
                DisplayGamePlayScreen("Pick Up Game Object", "It appears there are no objects currently in your inventory", ActionMenu.MainMenu, "");
            }
